# Generated by Django 5.2.4 on 2025-07-14 12:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('brand', models.CharField(choices=[('Samsung', 'Samsung'), ('Apple', 'Apple'), ('Xiaomi', 'Xiaomi'), ('Huawei', 'Huawei'), ('Oppo', 'Oppo'), ('Vivo', 'Vivo'), ('Other', 'Other')], max_length=50)),
                ('model', models.CharField(max_length=100)),
